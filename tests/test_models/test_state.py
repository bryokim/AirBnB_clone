...
class TestStateInstantiatesNoArgs(unittest.TestCase):
    """Class testing instantiation of State Class without arguments"""
...
class TestStateInstantiateWithAgs(unittest.TestCase):
    """Class for testing instantiation of a State with args"""
