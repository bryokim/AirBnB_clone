...
class TestPlaceInstantiatesNoArgs(unittest.TestCase):
    """Class testing instantiation of Place Class without arguments"""
...
class TestPlaceInstantiateWithAgs(unittest.TestCase):
    """Class for testing instantiation of a Place with args"""
